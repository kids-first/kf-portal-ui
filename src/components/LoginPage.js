...
import { withPageViewTracker, trackUserInteraction } from '../services/analyticsTracking';

import Login from 'components/Login';

const LoginPage = compose(withRouter, withTheme, withPageViewTracker, withApi)(
          ...
          <Link
            ...
            onClick={() => {
              trackUserInteraction({
                category: 'Join',
                action: 'Log in - Join Now clicked',
                label: 'Join Process Initiated'
              });
            }}
          >
