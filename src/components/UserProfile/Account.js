...
export default compose(
  ...
  <Box style={{ maxWidth: 1050 }} pr={4} pl={0} pt="8px">
    ...
    <SettingsSection>
      ...
      <Trans>The Kids First DRC provides the ability to integrate different data repositories. By connecting to each integration (powered by Gen3), you will immediately have the ability to analyze controlled datasets. Please remember that it is your responsibility to follow any data use limitations with controlled access data.</Trans>
