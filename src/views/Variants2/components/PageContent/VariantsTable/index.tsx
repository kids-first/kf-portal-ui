...
import ConsequencesCell from 'views/Variants2/components/ConsequencesCell';
import { SCROLL_WRAPPER_ID, VARIANT_SAVED_SETS_FIELD } from 'views/Variants2/utils/constants';
    ...
    render: (hgvsg: string, entity: IVariantEntity) =>
      hgvsg ? (
        <Tooltip placement="topLeft" title={hgvsg}>
          <Link to={`${STATIC_ROUTES.VARIANTS2}/${entity?.locus}`}>{hgvsg}</Link>
        </Tooltip>
      ) : (
