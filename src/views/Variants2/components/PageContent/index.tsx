...
import { useVariant } from 'graphql/variants2/actions';
import { IVariantResultTree } from 'graphql/variants2/models';
import { GET_VARIANT_COUNT } from 'graphql/variants2/queries';
import {
  DEFAULT_OFFSET,
  DEFAULT_PAGE_INDEX,
  DEFAULT_PAGE_SIZE,
  ...
  DEFAULT_SORT_QUERY,
  VARIANT_REPO_QB_ID,
} from 'views/Variants2/utils/constants';
