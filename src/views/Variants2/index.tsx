...
import GenesUploadIds from 'views/Variants2/components/GeneUploadIds';
import VariantGeneSearch from 'views/Variants2/components/VariantGeneSearch';
import { VARIANT_REPO_QB_ID } from 'views/Variants2/utils/constants';
...
import styles from 'views/Variants2/index.module.scss';
...
const Variants = () => {
  ...
  const variantMappingResults = useGetExtendedMappings(INDEXES.VARIANTS2);
