...
describe('Page d\'un participant - Vérifier les informations affichées', () => {
  ...
  it('Panneau Biospecimens', () => {
    ...
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(5).contains('Histological Diagnosis (MONDO)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(6).contains('Histological Diagnosis (NCIT)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(7).contains('Histological Diagnosis (Source Text)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(8).contains('Anatomical Site (NCIT)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(9).contains('Anatomical Site (Source Text)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(10).contains('Tumor Descriptor (Source Text)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(11).contains('Tumor Location (Source Text)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(12).contains('Consent Code (dbGaP)').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(13).contains('Consent Type').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(14).contains('Volume').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(15).contains('Volume Unit').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(16).contains('Sample Availability').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(17).contains('Parent Sample ID').should('exist');
    cy.get('[id="biospecimen"] thead th[class="ant-table-cell"]').eq(18).contains('Parent Sample Type').should('exist');
    ...
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(9).contains('Other').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(10).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(11).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(12).contains('phs001110.c1').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(13).contains('GRU').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(14).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(15).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(16).contains('No').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(17).contains('SA_G25NX8A9').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(18).contains('Leukocyte').should('exist');
  });
  ...
  it('Panneau Files [SKFP-1148]', () => {
    ...
    cy.get('[id="files"] [data-row-key="Genomics"] td[class="ant-table-cell"]').eq(1).contains(/^4$/).should('exist');
    ...
    cy.get('[id="files"] [data-row-key="WGS"] td[class="ant-table-cell"]').eq(1).contains(/^4$/).should('exist');
    ...
    cy.get('[id="files"] [data-row-key="Whole Exome Sequencing"] td[class="ant-table-cell"]').eq(1).contains(/^0$/).should('exist');
    cy.get('[id="files"] [data-row-key="Whole Exome Sequencing"] td[class="ant-table-cell"]').eq(2).find('[style*="width: 0%"]').should('exist');
