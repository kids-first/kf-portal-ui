...
describe('Page d\'un participant - Vérifier les informations affichées', () => {
  ...
  it('Panneau Biospecimens', () => {
    ...
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(9).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(10).contains('Other').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(11).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(12).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(13).contains('-').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(14).contains('phs001110.c1').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(15).contains('GRU').should('exist');
    cy.get('[data-row-key="BS_KB0GZCP5"] td[class="ant-table-cell"]').eq(16).contains('-').should('exist');
