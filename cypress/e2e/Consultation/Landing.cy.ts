...
describe('Page Landing - Vérifier les informations affichées', () => {
  ...
  it('Section Released Data Stats', () => {
    ...
    cy.get('[class*="Grid_statsGrid"] [class*="Grid_stats"] [class*="Grid_data"]').eq(0).contains(/\d{1}/).should('exist');
    ...
    cy.get('[class*="Grid_statsGrid"] [class*="Grid_stats"] [class*="Grid_data"]').eq(1).contains(/\d{1}/).should('exist');
    ...
    cy.get('[class*="Grid_statsGrid"] [class*="Grid_stats"] [class*="Grid_data"]').eq(2).contains(/\d{1}/).should('exist');
    ...
    cy.get('[class*="Grid_statsGrid"] [class*="Grid_stats"] [class*="Grid_data"]').eq(3).contains(/\d{1}/).should('exist');
    ...
    cy.get('[class*="Grid_statsGrid"] [class*="Grid_stats"] [class*="Grid_data"]').eq(4).contains(/\d{1}/).should('exist');
    ...
    cy.get('[class*="Grid_statsGrid"] [class*="Grid_stats"] [class*="Grid_data"]').eq(5).contains(/\d{1}/).should('exist');
