...
describe('Page d\'un variant - Vérifier les informations affichées', () => {
  ...
  it('Panneau Summary', () => {
    ...
    cy.get('div[class*="EntityVariantSummary_bannerWrapper"] [class="ant-space-item"]').eq(3).contains('p.Val136Met').should('exist');
    ...
    cy.get('div[class*="EntityVariantSummary_bannerWrapper"] [class="ant-space-item"]').eq(11).contains('135 / 242(5.58e-1)').should('exist');
    cy.get('div[class*="EntityVariantSummary_bannerWrapper"] [class="ant-space-item"]').eq(11).find('a').contains('135').should('exist');
    cy.get('div[class*="EntityVariantSummary_bannerWrapper"] [class="ant-space-item"]').eq(12).contains('gnomAD').should('exist');
    cy.get('div[class*="EntityVariantSummary_bannerWrapper"] [class="ant-space-item"]').eq(13).contains('2.46e-1').should('exist');
    // Info
    cy.get('div[class*="EntityVariantSummary_infoWrapper"] div[class*="ant-space-item"]').eq(1).contains('ENST00000619721').should('exist');
    cy.get('div[class*="EntityVariantSummary_infoWrapper"] div[class*="ant-space-item"]').eq(2).find('svg[class*="VariantEntity_canonicalIcon"]').should('exist');
    cy.get('div[class*="EntityVariantSummary_infoWrapper"] div[class*="ant-space-item"]').eq(3).contains('NM_031433.4').should('exist');
    cy.get('div[class*="EntityVariantSummary_infoWrapper"] [class*="ant-typography"]').eq(0).contains('c.406C>T').should('exist');
    cy.get('div[class*="EntityVariantSummary_infoWrapper"] div[class*="ant-space-item"]').eq(4).contains('rs3814762').should('exist');
    // Details
  ...
  it('Panneau Transcripts', () => {
    ...
    cy.get('[id="consequence"] tbody td[class="ant-table-cell"]').eq(0).contains('MFRP').should('exist');
    ...
    cy.get('[id="consequence"] tbody td[class="ant-table-cell"]').eq(2).contains('1.31e-15').should('exist');
    cy.get('[id="consequence"] tbody td[class="ant-table-cell"]').eq(3).contains('1.223').should('exist');
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(0).contains('p.Val136Met').should('exist');
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(2).contains('c.406C>T').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(0).contains('CADD (Raw)').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(1).contains('-1.152731').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(2).contains('CADD (Phred)').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(3).contains('0.003').should('exist');
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(4).contains('-1.031').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(5).contains('ENST00000619721').should('exist');
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(6).contains('NM_031433.4').should('exist');
  });
  ...
  it('Panneau Kids First Studies', () => {
    ...
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(1).contains('135 / 242').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(2).contains('3.37e-1').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(3).contains('163').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(4).contains('28').should('exist');
  ...
  it('Panneau Public Cohorts', () => {
    ...
    cy.get('[data-row-key="topmed"] td[class="ant-table-cell"]').eq(1).contains('30,191').should('exist');
    cy.get('[data-row-key="topmed"] td[class="ant-table-cell"]').eq(2).contains('125,568').should('exist');
    cy.get('[data-row-key="topmed"] td[class="ant-table-cell"]').eq(3).contains('4,544').should('exist');
    cy.get('[data-row-key="topmed"] td[class="ant-table-cell"]').eq(4).contains('2.40e-1').should('exist');
    cy.get('[data-row-key="gnomadGenomes3"] td[class="ant-table-cell"]').eq(1).contains('37,345').should('exist');
    cy.get('[data-row-key="gnomadGenomes3"] td[class="ant-table-cell"]').eq(2).contains('151,884').should('exist');
    cy.get('[data-row-key="gnomadGenomes3"] td[class="ant-table-cell"]').eq(3).contains('5,541').should('exist');
    cy.get('[data-row-key="gnomadGenomes3"] td[class="ant-table-cell"]').eq(4).contains('2.46e-1').should('exist');
    cy.get('[data-row-key="gnomadGenomes2_1"] td[class="ant-table-cell"]').eq(1).contains('7,710').should('exist');
    cy.get('[data-row-key="gnomadGenomes2_1"] td[class="ant-table-cell"]').eq(2).contains('31,280').should('exist');
    cy.get('[data-row-key="gnomadGenomes2_1"] td[class="ant-table-cell"]').eq(3).contains('1,125').should('exist');
    cy.get('[data-row-key="gnomadGenomes2_1"] td[class="ant-table-cell"]').eq(4).contains('2.46e-1').should('exist');
    cy.get('[data-row-key="gnomadExomes2_1"] td[class="ant-table-cell"]').eq(1).contains('65,587').should('exist');
    cy.get('[data-row-key="gnomadExomes2_1"] td[class="ant-table-cell"]').eq(2).contains('247,454').should('exist');
    cy.get('[data-row-key="gnomadExomes2_1"] td[class="ant-table-cell"]').eq(3).contains('9,618').should('exist');
    cy.get('[data-row-key="gnomadExomes2_1"] td[class="ant-table-cell"]').eq(4).contains('2.65e-1').should('exist');
  ...
  it('Panneau ClinVar', () => {
    ...
    cy.get('[id="pathogenicity"] [class*="ant-collapse-header-text"]').contains('167299').should('exist');
    ...
    cy.get('[id="pathogenicity"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(1).contains('Retinal degeneration').should('exist');
    ...
    cy.get('[id="pathogenicity"] tr[class*="ant-table-row"]').eq(2).find('td[class="ant-table-cell"]').eq(1).contains('Isolated microphthalmia 5').should('exist');
    ...
    cy.get('[id="pathogenicity"] tr[class*="ant-table-row"]').eq(3).find('td[class="ant-table-cell"]').eq(1).contains('Isolated microphthalmia 6').should('exist');
  ...
  it('Panneau Gene - Phenotype Association', () => {
    ...
    cy.get('[data-row-key="0-mfrp"] td[class="ant-table-cell"]').eq(0).contains('Orphanet').should('exist');
    cy.get('[data-row-key="0-mfrp"] td[class="ant-table-cell"]').eq(1).contains('MFRP').should('exist');
    cy.get('[data-row-key="0-mfrp"] td[class="ant-table-cell"]').eq(2).contains('Nanophthalmos').should('exist');
    cy.get('[data-row-key="0-mfrp"] td[class="ant-table-cell"]').eq(2).find('[class*="ColorTag_default"]').contains('AD').should('exist');
    cy.get('[data-row-key="0-mfrp"] td[class="ant-table-cell"]').eq(2).find('[class*="ColorTag_default"]').contains('AR').should('exist');
    cy.get('[data-row-key="2-mfrp-606227"] td[class="ant-table-cell"]').eq(0).contains('OMIM').should('exist');
    cy.get('[data-row-key="2-mfrp-606227"] td[class="ant-table-cell"]').eq(1).contains('MFRP (MIM:').should('exist');
    cy.get('[data-row-key="2-mfrp-606227"] td[class="ant-table-cell"]').eq(2).contains('Microphthalmia, Isolated 5 (MIM:').should('exist');
    cy.get('[data-row-key="2-mfrp-606227"] td[class="ant-table-cell"]').eq(2).find('[class*="ColorTag_default"]').contains('AR').should('exist');
    cy.get('[data-row-key="4-mfrp"] td[class="ant-table-cell"]').eq(0).contains('HPO').should('exist');
    cy.get('[data-row-key="4-mfrp"] td[class="ant-table-cell"]').eq(1).contains('MFRP').should('exist');
    cy.get('[data-row-key="4-mfrp"] td[class="ant-table-cell"]').eq(2).contains('Microphthalmia').should('exist');
    cy.get('[data-row-key="6-mfrp"] td[class="ant-table-cell"]').eq(0).contains('DDD').should('exist');
    cy.get('[data-row-key="6-mfrp"] td[class="ant-table-cell"]').eq(1).contains('MFRP').should('exist');
    cy.get('[data-row-key="6-mfrp"] td[class="ant-table-cell"]').eq(2).contains('MICROPHTHALMIA ISOLATED TYPE 5').should('exist');
  });
});
...
describe('Page d\'un variant - Valider les liens disponibles', () => {
  ...
  it('Lien du gène du panneau Transcripts', () => {
    cy.get('[id="consequence"] tbody td[class="ant-table-cell"]').eq(0).find('[href]').eq(0).should('have.attr', 'href', 'https://www.omim.org/entry/606227');
  });
  ...
  it('Lien \'See more\' de Prediction du panneau Transcripts', () => {
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(2).contains('CADD (Phred)').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(3).contains('0.003').should('exist');
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(3).find('span[class*="ant-typography"]').eq(4).contains('DANN').should('exist');
  ...
  it('Lien du transcript du panneau Transcripts', () => {
    cy.get('[id="consequence"] tbody td[class*="ant-table-row-expand-icon-cell"]').eq(0).find('button').clickAndWait({force: true});
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(5).find('a').should('have.attr', 'href', 'https://www.ensembl.org/id/ENST00000619721');
  });

  it('Lien du RefSeq du panneau Transcripts', () => {
    cy.get('[id="consequence"] tbody td[class*="ant-table-row-expand-icon-cell"]').eq(0).find('button').clickAndWait({force: true});
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(6).find('a').should('have.attr', 'href', 'https://www.ncbi.nlm.nih.gov/nuccore/NM_031433.4?report=graph');
  ...
  it('Lien de la condition Orphanet du panneau Gene - Phenotype Association', () => {
    cy.get('[data-row-key="0-mfrp"] td[class="ant-table-cell"]').eq(2).find('[href]')
  ...
  it('Lien OMIM du gène du panneau Gene - Phenotype Association', () => {
    cy.get('[data-row-key*="2-mfrp-606227"] td[class="ant-table-cell"]').eq(1).find('[href]')
    .should('have.attr', 'href', 'https://www.omim.org/entry/606227');
  });

  it('Lien OMIM de la condition du panneau Gene - Phenotype Association', () => {
    cy.get('[data-row-key*="2-mfrp-606227"] td[class="ant-table-cell"]').eq(2).find('[href]').first()
    .should('have.attr', 'href', 'https://www.omim.org/entry/611040');
  });

  it('Lien HPO de la condition du panneau Gene - Phenotype Association', () => {
    cy.get('[data-row-key*="4-mfrp"] td[class="ant-table-cell"]').eq(2).find('[href]').eq(0)
