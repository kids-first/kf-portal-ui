...
describe('Page Login', () => {
  it('Vérifier les informations affichées', () => {
    ...
    cy.contains(/Data from over \d{2}\,\d{3} samples\, including whole genome sequencing \(WGS\) and RNA\-Sequencing\, is available to empower your research today\./).should('exist');
