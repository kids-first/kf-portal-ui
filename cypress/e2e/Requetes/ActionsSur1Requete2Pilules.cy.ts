...
describe('Page Data Exploration - Requêtes', () => {
  ...
  it('Modifier l\'opérateur d\'une requête', () => {
    ...
    cy.validateTotalSelectedQuery(/(26.1K|27.1K|32.7K|32.8K)/);
    cy.validateTableResultsCount(/(26,073|27,072|27,094|32,675|32,697|32,760)/);
    ...
    cy.validateTotalSelectedQuery(/(1,843|2,676|2,696|7,623|7,643|7,705)/);
    cy.validateTableResultsCount(/(1,843|2,676|2,696|7,623|7,643|7,705)/);
    cy.validateClearAllButton(false);
  });
  ...
  it('Supprimer une des pilules d\'une requête avec le X', () => {
    ...
    cy.validateTotalSelectedQuery(/(1,843|2,770|2,792|8,365|8,387|8,447)/);
    cy.validateTableResultsCount(/(1,843|2,770|2,792|8,365|8,387|8,447)/);
    cy.validateClearAllButton(false);
  });
});
